...
1. Render the page/file containing the plates:
   - Preferred: `python3 ~/.Codex/skills/design-loop/shot.py <file> --out-dir <tmp> --desktop-only`
...
4. If the design-loop skill is installed (`~/.Codex/skills/design-loop/log_reject.py`),
