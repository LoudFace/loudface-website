...
```
plan.ts         Codex reads the article → Zod-validated shot list (5–10)
...
Run `--plan-only` to get a Zod-validated shot list as JSON. If Codex's
...
The planner prompt warns Codex not to guess selectors for volatile SPAs
