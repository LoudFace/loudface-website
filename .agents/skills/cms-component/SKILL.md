...
Create React components that render Sanity CMS data. For general component patterns (templates, carousel setup, server vs client decisions), see `.Codex/rules/component-patterns.md` — it's always loaded in context.
...
- **Component patterns**: `.Codex/rules/component-patterns.md` (templates, server vs client, carousel setup)
- **Styling tokens**: `.Codex/rules/styling.md` (colors, typography, spacing)
- **Collection IDs**: `AGENTS.md` → "CMS Collection IDs" table
