...
description: "Migrated source command `audit`"
---
...
Use the Grep tool (not bash grep) to search for patterns. Reference the accessibility-audit and performance-audit agents in `.Codex/agents/` for detailed checklists.
