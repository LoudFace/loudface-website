      ...
      >
        ...
        <div className="bg-surface-50 px-3.5 py-2 border-b border-surface-200 flex items-center gap-3">
          <div className="flex gap-1.5">
            <div className="w-2 h-2 rounded-full" style={{ background: 'var(--color-chrome-close)' }} />
            <div className="w-2 h-2 rounded-full" style={{ background: 'var(--color-chrome-min)' }} />
            <div className="w-2 h-2 rounded-full" style={{ background: 'var(--color-chrome-max)' }} />
          </div>
