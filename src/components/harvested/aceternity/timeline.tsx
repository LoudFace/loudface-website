"use client";
/**
 * Harvested VERBATIM from Aceternity UI (`components/ui/timeline.tsx`,
 * https://ui.aceternity.com/components/timeline, registry:
 * https://ui.aceternity.com/registry/timeline.json). Structure, spacing,
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-primary-600 via-primary-400 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
