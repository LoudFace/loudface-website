/**
 * edtech — the v11 industry long read (IndustryArticleV11, switched 2026-09-26). The copy moved unchanged into
 * seo-for-edtech.json. Metadata and the BreadcrumbList + Service JSON-LD are unchanged; the FAQPage JSON-LD reads the
...
export default async function EdtechRoutePage() {
