          ...
          <div className="hr-hero-proof rv" style={{ ['--d' as string]: '.14s' }}>
            <div className="mat">
              <div className="plate">
                ...
                <div className="shot"><Image src={`${CEIPAL_IMAGE}?w=1080&h=836&fit=crop&crop=top&fm=webp&q=82`} alt="CEIPAL website migrated by LoudFace from WordPress to Webflow" width={1080} height={836} quality={82} loading="eager" fetchPriority="high" /></div>
              </div>
            </div>
