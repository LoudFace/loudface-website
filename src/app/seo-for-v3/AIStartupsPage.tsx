...
export const AI_STARTUPS_FAQ_ITEMS = [
  ...
  ['Does LoudFace have AI-native clients?', 'Yes. Bluefyn is an AI verification product, and its AI visibility rose more than 5x on a fixed set of tracked buyer prompts across two 30-day windows 83 days apart, with ChatGPT visibility up 13x and average position when named improving to under 2. Pond is an AI workforce marketplace, and its AI visibility tripled from a near-zero base in the first four weeks. Those are visibility and position figures. Neither one is a revenue figure.'],
