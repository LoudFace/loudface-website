  ...
  return (
    <>
      ...
      <section className="hr-feature hr-migration">
        <div>
          <h2>Results from two AI-native clients</h2>
          ...
          <p>Pond (joinpond.ai) runs an AI workforce marketplace. AI visibility tripled from a near-zero base in the first four weeks, and Pond went from absent to named on Google AI Mode. The base is small and the programme is four weeks old, so read it as a standing start.</p>
          <p>Both companies sell an AI product rather than software that uses AI internally, so both sit inside the definition this page uses. Outside the AI-native vertical, the <Link href="/case-studies/stealth-fintech-ai-visibility">Stealth Fintech</Link> and <Link href="/case-studies/genie-teacher-organic-growth">Genie Teacher</Link> case studies document the same method in other categories. Every figure above is an AI visibility, share of voice or average position figure. None of them is a revenue figure.</p>
        </div>
