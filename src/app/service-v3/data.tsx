...
export const SERVICE_CONFIGS: Record<string, ServiceConfig> = {
  ...
  'seo-aeo': {
    ...
    exhibit: {
      ...
      out: { num: '97.8%', label: 'Toku AI visibility on its core prompt (30-day Peec reading ending 19 August 2026; average cited position 3.1 on that prompt)', src: 'Toku · SEO/AEO' },
      ctaLabel: 'See the full case study',
      ctaHref: TOKU_HREF,
    },
    proof: {
  ...
  'organic-growth': {
    ...
    exhibit: {
      ...
      out: { num: '97.8%', label: 'AI visibility for Toku on its core prompt (30-day Peec reading ending 19 August 2026; average cited position 3.1 on that prompt)', src: 'Toku · Organic growth' },
      ctaLabel: 'See the full case study',
      ctaHref: TOKU_HREF,
    },
    proof: {
  ...
  'geo-agency': {
    ...
    proof: {
      ...
      hero: { num: '97.8%', label: 'Toku’s AI visibility on its core prompt (30-day Peec reading ending 19 August 2026; average cited position 3.1 on that prompt)', src: 'Toku · GEO' },
    ...
    faq: {
      ...
      items: [
        { q: 'What does a GEO agency do?', aHtml: 'It gets your brand retrieved, cited, and recommended by AI engines like ChatGPT, Perplexity, and Google AI Overviews. The work spans a visibility audit, content formatted so engines can quote it, entity and schema signals, placement in the third-party sources engines read, and per-engine measurement, sequenced as <a href="/methodology">the eight-stage Answer Chain we publish</a>. The outcome metric is share of answer: how often the engines name you when buyers ask. If you are comparing agencies, <a href="/blog/best-geo-agencies-b2b-saas-2026">see our ranked list of 18 generative engine optimization agencies for B2B SaaS</a>.' },
