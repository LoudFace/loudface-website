  ...
  return {
    ...
    clipStrip: {
      ...
      clips: [
        ...
        { _key: 'rc5', videoUrl: 'https://cdn.sanity.io/files/xjjjqhgt/proposals/77f7444f1da7ed7a221c1637d897a0f4ec3e87aa.mp4', posterUrl: 'https://cdn.sanity.io/images/xjjjqhgt/proposals/de273c76a554c38b859f28b548117f29b28d6022-1280x720.jpg', name: 'Client testimonial', label: 'name to confirm', duration: '1:53', orientation: 'landscape' },
      ],
    },
    proofRail: withRail
      ? {
