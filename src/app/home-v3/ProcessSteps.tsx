...
const STEPS = [
  ...
  },
  {
    ...
    body: 'We audit discovery, content, conversion, and the current stack. Then we start the work with the clearest route to customers. If a site or page is the constraint, we scope the delivery work.',
    live: false,
    delay: '.07s',
  },
  {
    ...
    body: 'We ship the agreed work, set up analytics where needed, and establish baseline metrics. No vanity dashboards. We track the numbers that connect to pipeline: organic traffic, conversion rates, form submissions, and qualified lead volume.',
    live: true,
    delay: '.14s',
  },
  {
