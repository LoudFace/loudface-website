...
const proofRail = {
  ...
  quotes: withKeys([
    ...
    { _type: 'railQuote', author: 'E-learning platform, verified client', platform: 'clutch', text: 'Working with LoudFace has been refreshing; we were surprised by their passion.' },
