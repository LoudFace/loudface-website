...
const doc = await client.fetch(`*[_type == "blogPost" && slug.current == "share-of-answer-audit-90-minutes"][0]{_id, name, metaTitle, metaDescription, publishedDate, lastUpdated, "len": length(content), excerpt}`);
