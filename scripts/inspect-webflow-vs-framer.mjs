...
const doc = await client.fetch(`*[_type == "blogPost" && slug.current == "webflow-vs-framer-ultimate-showdown"][0]{_id, name, metaTitle, metaDescription, excerpt, lastUpdated, "contentLength": length(content)}`);
