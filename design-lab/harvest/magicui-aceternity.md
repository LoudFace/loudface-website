# MagicUI + Aceternity Harvest — Process/Steps + Stats/Metrics

Fetched via each site's shadcn-style registry JSON endpoint (`https://magicui.design/r/<slug>.json`, `https://ui.aceternity.com/registry/<slug>.json`) using curl, so this is the literal source, not a paraphrase.


## Category A — Process / Steps / Timeline / Scroll-Progress / Tracing-Beam
...
**File: `components/ui/tracing-beam.tsx`**
...
## Category B — Stats / Metrics / Counters / Testimonial Grids / Marquees
...
**File: `registry/magicui/marquee.tsx`**
...
Dependencies: @radix-ui/react-icons | registry deps: button
