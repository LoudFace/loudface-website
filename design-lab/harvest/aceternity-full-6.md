# Aceternity UI — Full Component Harvest (Part 2, continued 6/6)

See `aceternity-full-1.md` for the table of contents and summary.

_(continuing **Utilities & Overlays**)_

### 93. `terminal` — Terminal

- URL: https://ui.aceternity.com/components/terminal
- Registry source: https://ui.aceternity.com/registry/terminal.json
...
These returned HTTP 401 Unauthorized from the registry endpoint. They are either gated behind
Aceternity's paid "Blocks"/Pro tier, or are category/listing pages with no standalone registry
JSON (e.g. the `-free` suffixed slugs, which are section headers on the components page, not
individually installable components).

- `3d-card-effect` — https://ui.aceternity.com/components/3d-card-effect
- `cards-free` — https://ui.aceternity.com/components/cards-free — category-listing slug, not an individually installable component
...
- `feature-sections-free` — https://ui.aceternity.com/components/feature-sections-free — category-listing slug, not an individually installable component
...
- `hero-sections-free` — https://ui.aceternity.com/components/hero-sections-free — category-listing slug, not an individually installable component
