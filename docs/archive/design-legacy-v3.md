> **Archived 2026-09-25. Not an authority.** The design system is `DESIGN.md` (v11). This file keeps the v3
> spec and the pre-v3 reference for history only; the parts that still hold (voice, copy bans, contrast) were
> carried into `DESIGN.md` §1 and §8. Where anything here disagrees with `DESIGN.md`, `DESIGN.md` wins.

# Legacy — v3 (pre-2026-09-24)
